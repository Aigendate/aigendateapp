...
import { z } from "zod";
import { initDb, listHospitals, registerPatient, listPatients, createAppointment, listAppointments, cancelAppointment } from "./db.js";
